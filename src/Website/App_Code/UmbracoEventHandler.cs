namespace Website
{
    ...
    public class UmbracoEventHandler : IApplicationEventHandler
    {
        ...
        public void OnApplicationStarting(UmbracoApplicationBase umbracoApplication, ApplicationContext applicationContext)
        {
            ...
            // so that published content queries in views will work correctly.  This also is required for culture setting
            // in multi-lingual implementations where the assigned parent is the root of specific culture.
            // -------------------------------------------------------------------------------------
